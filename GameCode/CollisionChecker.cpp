...
bool CollisionChecker::doesRectangleVsRectangleCollide(const Rect& r1, const Rect& r2) {
...
void CollisionChecker::doesRectangleVsRectangleCollide(const Rect& r1, const Rect& r2, CollisionInfo& collisionInfo) {
	float r1halfwidth = r1.width / 2.0f;
	float r1halfheight = r1.height / 2.0f;
	float r1minx = r1.x - r1halfwidth;
	float r1miny = r1.y - r1halfheight;
